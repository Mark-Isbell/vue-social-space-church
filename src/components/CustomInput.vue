    ...
    <div>
        ...
        <div class="FileInput--file-input-wrapper">
            <label class="btn btn-primary">
                <input class="file" type="file" ref="file" v-on:change="emitFileChange" v-show="false"
                    :accept="acceptType" />
    ...
    setup(props, context) {
        ...
        const emitFileChange = () => {
            if (file.value.files.length > 0) {
                ...
                useImage.actualImageFile = fileAux;

                // create base 64 version of image
                const reader = new FileReader();
                reader.readAsDataURL(useImage.actualImageFile);
                reader.onload = function () {
                    useImage.previewImageBase64 = reader.result;
                };

                useImage.imageSize = fileAux.size;
